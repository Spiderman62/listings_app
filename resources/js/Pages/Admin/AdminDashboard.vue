    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-end gap-2">
            ...
            <Link
                ...
                v-if="params.search" :href="route('admin.index',{...params,search:null,page:null})">{{ params.search }}
        ...
        <div
            ...
            <label for="toggleRole" class="block text-sm font-medium text-slate-700 dark:text-slate-300 cursor-pointer">Show
            ...
            <td class="w-1/6 py-5 px-3">
                <div class="flex items-center gap-6">
                    <div class="flex items-center gap-1">
                        <p>{{ user.listings.filter(listing => listing.approved).length }}</p>
